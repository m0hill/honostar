---
url: "https://diataxis.fr/_/downloads/en/latest/pdf/"
title: "Diátaxis"
---
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/0ae992a7a02c4bc840daca1ed8edd1f168d2bc38e448285cc9169235235a786a.jpg)

Diátaxis, from the Ancient Greek : dia (“across”) and taxis (“arrangement”).
...
• Explanation in more detail • Understanding the difference between reference and explanation
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/9720f74a6b516525cd5d44d488a2510fa6c67f9d82d906c87182f896ea7f0e9a.jpg)

# 1.1.3 The Diátaxis compass

As you can see from the map:

• tutorials and how-to guides are concerned with what the user does (action) • reference and explanation are about what the user knows (cognition)

On the other hand:

• tutorials and explanation serve the acquistion of skill (the user’s study) • how-to guides and reference serve the application of skill (the user’s work)
...
• Tutorials - learning-oriented experiences • How-to guides - goal-oriented directions • Reference - information-oriented technical description • Explanation - understanding-oriented discussion
...
• The compass - a simple tool for direction-finding • Workflow in Diátaxis

# 1.3 Tutorials

A tutorial is an experience that takes place under the guidance of a tutor. A tutorial is always learningoriented.
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/f5fc5c81d5c92e7e4d75cd3f5454a9b24986c6de83fdacd5788604de6155052b.jpg)
...
A lesson is a learning experience. In a learning experience, what matters is what the learner does and what happens.
...
Instead, allow learning to take place, and trust that it will. Give your learner things to $d o$ , through which they can learn. Only your pupil can learn. Sadly, however much you desire it, you will not be able to learn for your pupil. You cannot make them learn. All you can do is make it so they can learn.
...
If you know know in advance what the likely signs of going wrong are, consider flagging them: “If the output doesn’ show . . . , you have probably forgotten to . . . ”.
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/f845874708aa0862852fa0c820e91a2c78ee791783b2dc4db7ca7f0b3c62af69.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/2b8c80a671bbeef922b907f59398f1657e7a6079fee681225ecc0482f69e07de.jpg)
...
• “To shut off the flow of water, turn the tap clockwise.” • “To deploy the desired database configuration, select the appropriate options and press Deploy.”
...
• how much water to run, and how vigorously to run it, for a certain purpose • what database configuration options align with particular real-world needs
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/d20f9a195be0fd4589512251ec5c7a5871ec7fcfcdd5d811e649b12979db927a.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/756f7c3616d67080fd711f7b7583ba80ad094d55e50d8159ffff67070b2abb72.jpg)
...
ub-commands are: a, b, c, d, e, f. List commands, options, operations, features, flags, limitations, error messages, etc.
...
|                                                                                                                                                                                                                                                                                                                                |          |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------- |
| Vaoiziali alvalues per 100g / Valeurs nutritionnelles moyennes pour100g / Durchschnittliche Nährwerte je 100g / Valoresnutricionales medios por 100g / Valores nutricionaismédios por 100g / Gemiddelde voedingswaarde per 100g/Gennemsnit naringsvardier for 100g / Genomsnittligtnäringsvärde per 100gEnrgiaergiane 365 kcal |
| 365 kcal                                                                                                                                                                                                                                                                                                                       |
| assi gasseseaLipidos-VettenFedtFett assd: acides gras satuésdavon: gesätgteFetten as cales: tasos is:saturados-waarvan: verzadigde vetzuren                                                                                                                                                                                    | 3.,91,29 |
| CdraCaaGucisKiatKoolydratenKulhydratKola zchhich:suasdavon: Zucker - de los cuales: azucares - dosquais: açúcares -waarvan: suikers -heraf:sukkerarter-varav: sockerarter                                                                                                                                                      | 66g2,99  |
| FieFiF                                                                                                                                                                                                                                                                                                                         | 2,9g     |
| ieProteinasiteot                                                                                                                                                                                                                                                                                                               | 15g      |
| aeSaltelalalZoa                                                                                                                                                                                                                                                                                                                | 0,12 g   |
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/066b9828f1e33a5aac9e5e76fc6db42b57d2c608f17655ad5aeefdc8d5c4e75b.jpg)
...
• Discussion • Background • Conceptual guides • Topics
...
• choices, alternatives, possibilities • why: reasons and justifications
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/693fbca771511082b5b90ffbb415f95fc05d4c3ccff9172a4bee844c442c3fc9.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/d8d281d205d876707e0f5a78b04fccf2aed8fa73115f03ad52f0191a6b918530.jpg)
...
It’s natural to want to complete large tranches of work before you publish them, so that you have something substantia to show each time. Avoid this temptation - every step in the right direction is worth publishing immediately.
...
Working like this helps reduce the stress of one of the most paralysing and troublesome aspects of the documentationwriter’s work: working out what to do. It keeps work flowing in the right direction, always towards the desired end, without having to expend energies on a plan.
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/f17b2e63e8de775cd55cab4547bec72aad5119ff30bea28010591d4b7035f187.jpg)

Linette Voller @mslane

Fig. 1: Illustration copyright Linette Voller 2021, reproduced with kind permission.
...
• Foundations - why Diátaxis works • The map - documentation in two dimensions • Towards a theory of quality in documentation

Common problems explored:

• The difference between a tutorial and how-to guide • The difference between reference and explanation • Diátaxis in complex hierarchies
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/d3dc610d81b7eb2c0290ec6fc0d38891dc885dc12814ac83c8add747be25ffaf.jpg)

This is a complete map. There are only two dimensions, and they don’t just cover the entire territory, they define it.

This is why there are necessarily four quarters to it, and there could not be three, or five. It is not an arbitrary number.
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/986fd2ea7308a132d581cec55310dc9c4d9e9452af3ec15e52f6427e67cdf621.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/7abadbd08eb26c7eefb7290db1c251f8e844732ccf35e8d2233437f3fbaa1274.jpg)
...
| what they do        | lead        | introduce, educate, guide |                                                 | state, describe, in- explain, clarify, dis- form      | cuss                                  |
| answers question    | the to...?" | "Can you teach me         | "How do I. ..?"                                 | "What is...?"                                         | "Why...?"                             |
| oriented to purpose | learning    | to provide a learning     | goals to help achieve a par-                    | information to describe the ma- to illuminate a topic | understanding                         |
|                     | experience  |                           | ticular goal                                    | chinery                                               |                                       |
| form                | a lesson    |                           | a series of steps                               | dry description                                       | discursive explana- tion              |
| analogy             | to cook     |                           | teaching a child how a recipe in a cookery book | information on the back of a food packet              | an article on culinary social history |
...
TUTORIAOSW-TO GUIDES EXPLANATIQREFERENCE
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/b8d51fddeb58b300ef14af791e1c4ed40fa836f7d6f774b0f290b69182d4c998.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/0cbd99a6d85dacd0fe6349d3dcfc02ae662fa210024690040ef8ad5c1658b084.jpg)
...
Attaining functional quality means meeting high, objectively-measurable standards in multiple independent dimen sions, consistently. It requires discipline and attention to detail, and high levels of technical skill.
...
And, deep quality is conditional upon functional quality. Documentation can be accurate and complete and consisten without being truly excellent - but it will never have deep quality without being accurate and complete and consistent.

No user of documentation will experience it as beautiful, if it’s inaccurate, or enjoy the way it anticipates their needs if it’s inconsistent. The moment we run into such lapses the experience of documentation is tarnished.
...
Or, moving explanatory verbiage out of a tutorial (in accordance with Diátaxis demands) often has the effect of high lighting a section where the reader has been left to work something out for themselves.
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/60b6317df96e1d7f74e07ae0398479d91f45cb13ddb5444552eaeb30e9446aa4.jpg)
...
![](https://diataxis.fr/_/downloads/en/latest/pdf/images/92c6faef059ad2c2c06099e1209d01e87924c9f0e0a6a348bf78995446947b4b.jpg)

# "Pre-incision checklist, please."
...
A how-to guide will typically fork and branch, describing different routes to the same destination: If this, then that.
...
Imagine asking a friend, while out for a walk or over a drink, Can you tell me more about ? \- the answer or discussion that follows is most likely going to be an explanation of it.
...
It usually happens while writing reference material that starts to become expansive. For example, it’s perfectly reasonable to include illustrative examples in reference (just as an encyclopaedia might contain illustrations) - but examples are fun things to develop, and it can be tempting to develop them into explanation (using them to say why, or show what $i f ,$ or how it came to be).
...
|                               |                                  |
| ----------------------------- | -------------------------------- |
| Home Tutorial                 | <\- landing page <- landing page |
| Part 1 Part 2                 |                                  |
| Part 3 How-to guides Install  | <\- landing page                 |
| Deploy                        |                                  |
| Scale                         | <\- landing page                 |
...
| Installation guides                                                                                                     |
|                                                                                                                         |
| Pellentesque malesuada, ipsum ac mollis pellentesque, risus nunc ornare odio, et imperdiet dui mi et dui. Phasellus vel |
| porta turpis. In feugiat ultricies ipsum.                                                                               |
| \\\* Local installation I                                                                                               |
| \\\* Docker links to                                                                                                    |
| \|                                                                                                                      |
...
| laoreet tempus.                                          |
| \\\* Deploy an instance I links to                       |
| \\\* Scale your application I the guides                 |
...
• users • developers who build other products around it • the contributors who help maintain it.
...
• product-on-public-cloud-one • product-on-public-cloud-two • and so on. . .
...
I appreciate all the interest and do my best to reply, but I get a considerable quantity of email related to Diátaxis and can’t promise to respond to every message.
...
APA and BibTeX metadata are available from the Cite this repository option at [https://github.com/evildmp/](https://github.com/evildmp/) diataxis-documentation-framework.
